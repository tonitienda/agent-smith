...
| [AS-002](AS-002-wire-format-spike.md) | Spike: Anthropic/OpenAI wire-format union (D4) | schema | ready | 001 |
...
go run ./cmd/ticket-sync tickets/AS-017-keychain-key-storage.md   # sync specific files
