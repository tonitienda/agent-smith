...
| [AS-186](AS-186-interactive-pty-shell-tool.md) | Interactive PTY-driven shell tool ("full terminal use") | tools | Pending Debrief | AS-015, AS-016 |
| [AS-187](AS-187-repo-convention-rules-miner.md) | Repo-convention rules miner for `/init` and memory | capability | Pending Debrief | AS-039, AS-087, AS-032, AS-034 |
| [AS-188](AS-188-remote-steer-mobile-control-surface.md) | Remote-steer & mobile-friendly control surface over `smith serve` | faces | Pending Debrief | AS-077, AS-078, AS-171, AS-155 |
