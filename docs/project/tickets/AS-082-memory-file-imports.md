...
- [ ] A memory file with `@other.md` includes that file's content, attributed to
      `other.md` in `/context`.
- [ ] Cyclic and deeply-nested imports terminate within a documented depth limit.
- [ ] A missing/unreadable import surfaces a note and does not abort session start.
